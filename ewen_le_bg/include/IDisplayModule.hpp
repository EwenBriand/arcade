...
namespace GUI
{
    class IDisplayModule {
      public:
         ...
         * the event has some values associated with it. (for exemple the
         * coordinates of the mouse when a mouse click event is triggered) The
         * Event class also has a timestamp that can be used to know when the
         * event happened and sort them by order in time if needed.
         *
         */
        ...
        /**
         * @brief Collects the events that happened since the last call to
         * pollEvents.
         *
         * @return std::vector<event_t> the list of events that happened since
         * the last call.
         */
        virtual std::vector<event_t> pollEvents() = 0;

        /**
         * @brief Play a sound. If the sound is already playing, it will be
         * stopped and restarted. If the sound is not already loaded, it will
         * be loaded. If the sound is not found, nothing will happen.
         *
         * @param id is the path to the sound to play in the filesystem.
         * @param loop is a boolean that indicates if the sound should be
         * looped or not. Use it for your musics.
         */
        virtual void playSound(const std::string &id, bool loop = false) = 0;

        /**
         * @brief Stop a sound. If the sound is not playing, nothing will
         * happen.
         *
         ...
         *
         * @param between_zero_and_100 where 0 is mute and 100 is the maximum
         * volume.
         */
         ...
         *
         * @param multiplyer where 1 is the normal pitch and 2 is twice the
         * normal pitch.
         */
        ...
        /**
         * @brief Opens the window for the graphical lib. Initializes the
         * window.
         *
         * @param w width of the window, in the unit system of the graphical
         * lib.
         * @param h height of the window, in the unit system of the graphical
         * lib.
         */
        ...
        /**
         * @brief Clears the screen. All the pixels will be set to black /
         * transparent.
         *
         */
         ...
         * a 2D array of pixels stored internally by the library, with
         * dimensions set to w * h (the dimensions of the window).
         *
         */
         ...
         *
         * @param pixels a vector of pixel_t, each pixel_t representing a pixel
         * to change on the map. Pixels that are not explicitly set will not be
         * changed.
         */
        virtual void updatePixels(std::vector<pixel_t> pixels) = 0;

        /**
         * @brief Draws a text on the screen. It will be drawn last, above the
         * pixel map.
         *
         * @param text the text to draw.
         * @param x the x coordinate of the text, in the unit system of the
         * graphical lib.
         * @param y the y coordinate of the text, in the unit system of the
         * graphical lib.
         * @param color the color of the text, choosen from the enum color_t.
         */
        virtual void drawText(const std::string &text, int x, int y,
            const color_t &color = BLACK) = 0;
